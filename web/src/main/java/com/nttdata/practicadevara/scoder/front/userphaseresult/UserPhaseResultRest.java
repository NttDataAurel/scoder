...
//    }
      ...
      public List<UserPhaseResultDto> listUserPhaseResult() throws ClientErrorException {
        Response resp = super.path("/userphaseresult/UserPhaseResultList").request(MediaType.APPLICATION_JSON).get(Response.class);
        List<UserPhaseResultDto> ret = resp.readEntity(new GenericType<List<UserPhaseResultDto>>(){});
        return ret;
      }
    ...
    public List<UserPhaseResultDto> filterUserPhaseResult(String text) throws ClientErrorException {
        Response resp = super.path("/userphaseresult/userphaseresultsearch")
                ...
                .get(Response.class);
        return resp.readEntity(new GenericType<List<UserPhaseResultDto>>(){});
    }
    
    public UserPhaseResultDto update(UserPhaseResultDto entry) throws ClientErrorException, BackendException {
        Response resp = super.path("userphaseresult").request(MediaType.APPLICATION_JSON).post(javax.ws.rs.client.Entity.entity(entry, MediaType.APPLICATION_JSON), Response.class);
        UserPhaseResultDto ret = resp.readEntity(UserPhaseResultDto.class);
        return ret;
    }
    
    public UserPhaseResultDto create(UserPhaseResultDto entry) throws ClientErrorException, BackendException {
        Response resp = super.path("userphaseresult").request(MediaType.APPLICATION_JSON).put(javax.ws.rs.client.Entity.entity(entry, MediaType.APPLICATION_JSON), Response.class);
        UserPhaseResultDto ret = resp.readEntity(UserPhaseResultDto.class);
        return ret;
    }
}
